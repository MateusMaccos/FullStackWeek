...
const Trips = () => {
    ...
    return (
        <div className='container mx-auto flex flex-col p-5 items-center'>
            ...
            <h2 className='text-grayPrimary font-medium mb-5'>{trips.length > 0 ? `Listamos as melhores viagens com a busca: ${searchParams.get("text")}!` : 'Não encontramos nada nos seus parâmetros'}</h2>
