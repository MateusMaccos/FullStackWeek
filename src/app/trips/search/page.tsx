...
const Trips = () => {
    ...
    return (
        <div className='container mx-auto flex flex-col p-5 items-center lg:items-start'>
            <h1 className='text-primaryDarker font-semibold text-xl lg:text-left lg:text-[2.5rem]'>Viagens Encontradas</h1>
            <h2 className='text-grayPrimary font-medium mb-5 lg:mt-6 lg:w-full lg:text-left'>{trips.length > 0 ? `Listamos as melhores viagens com a busca: ${searchParams.get("text")}!` : 'Não encontramos nada nos seus parâmetros'}</h2>
